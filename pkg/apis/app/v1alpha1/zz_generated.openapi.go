...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"./pkg/apis/app/v1alpha1.AppService":       schema_pkg_apis_app_v1alpha1_AppService(ref),
		"./pkg/apis/app/v1alpha1.AppServiceSpec":   schema_pkg_apis_app_v1alpha1_AppServiceSpec(ref),
		"./pkg/apis/app/v1alpha1.AppServiceStatus": schema_pkg_apis_app_v1alpha1_AppServiceStatus(ref),
	}
}
...
func schema_pkg_apis_app_v1alpha1_AppService(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/app/v1alpha1.AppServiceSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/app/v1alpha1.AppServiceStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"./pkg/apis/app/v1alpha1.AppServiceSpec", "./pkg/apis/app/v1alpha1.AppServiceStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
